(function() {
    ...
    }]).controller("defaultController", function($scope, $rootScope, $http, $q, $routeParams, $window, $location, $resource, $cookies, cacheService, applicationService, userService, authService) {
